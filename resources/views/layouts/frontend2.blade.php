...
<head>
	...
	<!-- Favicon-->
	<link rel="shortcut icon" href="{{ URL::to('frontend/img/fav.png') }}">
	<!-- Author Meta -->
	...
	<!--
		CSS
		============================================= -->
	<link rel="stylesheet" href="{{ URL::to('frontend/css/linearicons.css') }}">
	...
	<link rel="stylesheet" href="{{ URL::to('frontend/css/ion.rangeSlider.css') }}" />
	<link rel="stylesheet" href="{{ URL::to('frontend/css/ion.rangeSlider.skinFlat.css') }}" />
		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="/"><img src="{{ URL::to('frontend/img/logo.png') }}" alt=""></a>
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							<li class="nav-item" ><a class="nav-link" href="{{url('products')}}">Articles</a></li>
							<li class="nav-item submenu dropdown">
								<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
								 aria-expanded="false">Boutiques</a>
							...
							<li class="nav-item" style="display:none;"><a class="nav-link" href="contact.html">Contact</a></li>
                            @guest
                            <li class="nav-item submenu dropdown">
								<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
								 aria-expanded="false"><span class="ti-user"></span> Se connecter</a>
								<ul class="dropdown-menu">
									<li class="nav-item"><a class="nav-link" href="{{ route('login') }}">se connecter</a></li>
									<li class="nav-item"><a class="nav-link" href="">creer un compte</a></li>
								</ul>
							</li>
						</ul>
                        ...
                        <li class="nav-item submenu dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                             aria-expanded="false"><span class="ti-user"></span> {{ Auth::user()->firstname }} {{ Auth::user()->lastname }} </a>
                            <ul class="dropdown-menu">
                                <li class="nav-item"><a class="nav-link" href="">Mon compte</a></li>
                                <li class="nav-item"><a class="nav-link" href="">Ma liste</a></li>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<script src="{{ URL::to('frontend/js/vendor/jquery-2.2.4.min.js') }}"></script>
	...
	<script src="{{ URL::to('frontend/js/gmaps.min.js') }}"></script>
