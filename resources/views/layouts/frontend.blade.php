...
<head>
    ...
    <!-- Title  -->
    <title>Tonnerre.com - Articles importés</title>

    <!-- Favicon  -->
    <link rel="icon" href="{{ URL::to('frontend/img/core-img/favicon.ico') }}">

    <!-- Core Style CSS -->
    <link rel="stylesheet" href="{{ URL::to('frontend/css/core-style.css') }}">
                ...
                <div class="col-12 col-md-6">
                    <div class="single_widget_area mb-30">
                        <ul class="footer_widget_menu">
                            ...
                            <li><a href="#">Envoies et Livraison</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="row mt-5">
    ...
    <!-- Classy Nav js -->
    <script src="{{ URL::to('frontend/js/classy-nav.min.js') }}"></script>
    <!-- Active js -->
